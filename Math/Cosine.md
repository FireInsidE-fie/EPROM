...
$$
## Interpretation
- $cos(0^∘) = 1$ - This means the vectors are perfectly aligned in the same direction.
- $cos(90^∘) = 0$ - This means the vector are orthogonal (perpendicular) to each other.
- $cos(180^∘) = -1$ - This means the vector are aligned, but in opposite directions.