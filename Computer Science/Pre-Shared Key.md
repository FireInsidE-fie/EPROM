...
# Security
It's good enough for noncritical systems such as monitoring software and other uses, but if you know your system might be the direct target for attacks, you might consider stronger alternatives such as [[Transport Layer Security]] certificates.
