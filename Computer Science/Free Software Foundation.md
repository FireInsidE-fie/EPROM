...
They enforce a type of licensing called "copyleft", which basically means (under the GNU General Public LIcense) that you are to publish every modification to their code and also publish any application that makes use of it.
