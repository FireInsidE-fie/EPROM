...
Not only that, this now really suspicious iframe has a command embedded in its URL, engineered to send all your savings to another account once logged in.
___
...
# Resources
- [MDN CSRF Article](https://developer.mozilla.org/en-US/docs/Web/Security/Attacks/CSRF)