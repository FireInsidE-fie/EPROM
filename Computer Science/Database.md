...
This structured data is stored in rows and columns in a table, where each column has a datatype that it is going to store.
...
Foreign keys allow **creating the actual relationships** with other tables. **It directly refers to a primary key of another table.**
### Use Cases
