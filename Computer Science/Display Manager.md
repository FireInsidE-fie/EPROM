...
It then reads instructions inside of those files to know what command to launch, and thus, a session is born (and you're dropped into Kwin, Gnome or whatever [[Window Manager]] you set up).