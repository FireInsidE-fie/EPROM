...
For all the namespaces listed below, each process has a reference to one (several processes could share one `net` namespace, for example), dictating what resources they have access to.
...
> This effectively **creates isolation**, as the process isn't even aware of the existence of others.
> To it, **it is the first process that was started on the system**.
