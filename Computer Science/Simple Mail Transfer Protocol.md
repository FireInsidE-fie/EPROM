...
# How It Works
Here is a rough overview of what happens when transferring an email to an SMTP server:
...
Instead, SMTP relies on security mechanisms enforced through the [[Domain Name System]].
