...
```
# Security
Telnet transmits all communications, including usernames and passwords, in plaintext.
...
Most useful of all, though, are its uses when **debugging network services such as [[Simple Mail Transfer Protocol]], [[Internet Relay Chat]] or [[HyperText Transfer Protocol]] servers**.
