...
>  # Sends the output of a command to a file, creating it if needed and erasing all contents found inside
>>  # Sends the output of a command to a file, creating it if needed and adding to the contents found inside
```
# Resources
