...
tags:
  ...
  - networking
---
A firewall is a hardware or software utility that **filters incoming and outgoing connections for a device of network**.
...
Consumes a lot of resources, since the decision making is dynamic on the entire connection.
...
As such, they do not block entire devices if one of their packets is bad; which makes them less robust than stateful firewalls. However, they also take way less resources to run.
